...
function activar(quien, //parametro obligatorio(debe ir al principio)
objeto = "batiseñal", //parametro por defecto, se usara si no se envia
momento) {
    let mensaje;
    if (momento) {
